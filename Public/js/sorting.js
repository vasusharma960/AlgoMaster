...
function selection(){
  document.getElementById("algorithm").innerHTML = "<object data='/text/selectionSort.txt'></h1>";
}

function bubble(){
  document.getElementById("algorithm").innerHTML = "<object data='/text/bubbleSort.txt'></h1>";
}

function insertion(){
  document.getElementById("algorithm").innerHTML = "<object data='/text/insertionSort.txt'></h1>";
}

function heapify(){
  document.getElementById("algorithm").innerHTML = "<object data='/text/heapSort.txt'></h1>";
}

function mer(){
  document.getElementById("algorithm").innerHTML = "<object data='/text/mergeSort.txt'></h1>";
}

function quicky(){
  document.getElementById("algorithm").innerHTML = "<object data='/text/quickSort.txt'></h1>";
}
